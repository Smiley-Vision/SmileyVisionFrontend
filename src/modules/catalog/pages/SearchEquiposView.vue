...
onMounted(async () => {
  try {
    ...
    categoryID.value = findCategoryIdByName(categories, 'equipos') ?? 0
...
<template>
  <div
    class="flex flex-col xl:px-20 md:px-12 px-8 px-14 lg:mt-14 lg:py-0 md:py-10 py-8 lg:gap-y-16 gap-y-8"
  >
    <div class="flex lg:flex-row flex-col justify-between lg:gap-y-0 gap-y-8">
      <!-- Descriptive title -->
      <div class="lg:text-4xl text-3xl font-semibold text-sky-800">Buscar equipos ópticos</div>
