...
<template>
  <section
    ...
    id="registration"
    class="scroll-mt-32 px-6 py-16 sm:px-8 lg:px-20"
  >
      ...
      <div class="mt-12 grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(280px,0.95fr)]">
        <div v-reveal="{ origin: 'left', distance: 40, duration: 780 }" class="space-y-6">
          ...
          <p class="max-w-3xl text-sm leading-7 text-slate-600 sm:text-base">
            Tu solicitud será revisada por nuestro equipo. Una vez validada tu óptica, recibirás
            instrucciones para activar tu cuenta y poder realizar compras.
          </p>
        </div>
        ...
        >
          <div
            class="relative flex aspect-square w-full max-w-[360px] items-center justify-center overflow-hidden"
          >
            <img
              :src="sendImage"
