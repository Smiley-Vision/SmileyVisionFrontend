  ...
  >
    ...
    <form v-else @submit.prevent="submitBatch" class="flex flex-col gap-6">
      ...
      <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
        ...
        <div>
          <label for="cylinder_min" class="block text-sky-700 font-medium mb-1"
            >Cilindro desde (cerca de 0)</label
          >
          <select
            id="cylinder_min"
        ...
        <div>
          <label for="cylinder_max" class="block text-sky-700 font-medium mb-1"
            >Cilindro hasta (mas negativo)</label
          >
          <select
            id="cylinder_max"
      ...
      <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 flex flex-col gap-2">
        ...
        <div class="text-sm text-slate-700">
          Valores de esfera: {{ validation.sphereCount }} | Valores de cilindro:
          {{ validation.cylinderCount }}
        </div>
    ...
    >
      ...
      <div class="text-sm text-emerald-800">
        Combinaciones ya existentes: {{ batchResult.skipped }}
      </div>
