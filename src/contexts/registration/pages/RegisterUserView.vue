...
<template>
    <div class="flex items-center justify-center bg-slate-100 px-4 py-12">
        <div class="w-full max-w-2xl overflow-hidden rounded-lg border border-sky-100 bg-white shadow-xl">
            ...
            <!-- Formulario -->
            <form @submit.prevent="submitRegistration" class="flex flex-col gap-5 border-t border-slate-200 px-6 py-8 sm:px-10">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input v-model="form.email" type="email" id="email" name="email" readonly
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input v-model="form.phone_number" type="tel" id="phone" name="phone" inputmode="numeric"
                        class="w-full rounded-md border border-slate-300 p-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                ...
                <div class="flex flex-col gap-2">
                    <label for="password_confirmation" class="font-semibold text-slate-800">Confirmar contraseña</label>
                ...
                <fieldset class="flex flex-col gap-4 border-t border-slate-200 pt-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <select v-model="form.address.city_id" id="city_id" name="city_id"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input v-model="form.address.district" type="text" id="district" name="district"
                            class="w-full rounded-md border border-slate-300 p-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            required />
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input v-model="form.address.external_number" type="number" id="external_number" name="external_number"
                            class="w-full rounded-md border border-slate-300 p-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            required />
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input v-model="form.address.internal_number" type="number" id="internal_number" name="internal_number"
                            class="w-full rounded-md border border-slate-300 p-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input v-model="form.address.between_a" type="text" id="between_a" name="between_a"
                            class="w-full rounded-md border border-slate-300 p-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            required />
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input v-model="form.address.between_b" type="text" id="between_b" name="between_b"
                            class="w-full rounded-md border border-slate-300 p-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            required />
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input v-model="form.address.postal_code" type="text" id="postal_code" name="postal_code" inputmode="numeric"
                            class="w-full rounded-md border border-slate-300 p-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            required />
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <textarea v-model="form.address.notes" id="notes" name="notes" rows="3"
                            class="w-full rounded-md border border-slate-300 p-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            required></textarea>
                    </div>
                </fieldset>
